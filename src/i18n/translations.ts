...
export const translations: Record<Locale, Translations> = {
  ru: {
    ...
    researchSubtitle: 'Более 20 лет изучения истории евреев в Латвии',
  ...
  lv: {
    ...
    eitcSubtitle: 'Pētījam Holokausta vēsturi un mūsdienīgas naida formas. Novēršam radikalismu. Stiprinām demokrātiju.',
    ...
    research: 'Pētījumi',
    researchSubtitle: 'Vairāk nekā 20 gadi Latvijas ebreju vēstures stūdiju',
    exhibitions: 'Izstādes',
    exhibitionsSubtitle: 'Rīgas geto un Latvijas Holokausta muzejā un ne tikai',
    concerts: 'Koncerti',
  ...
  en: {
    ...
    aboutTextFounded: 'Association Shamir was founded and received charity status in 2004.',
    ...
    donate: 'Donate:',
    footerTitle: 'Shamir Association',
    archive: 'Archive',
    search: 'Search',
    education: 'Education',
